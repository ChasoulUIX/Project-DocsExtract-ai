...
@section('title', 'Login - DocExtract AI')
    ...
    <div class="flex-1 flex items-center justify-center py-12 px-4">
        <div class="rounded-lg border border-border bg-card text-card-foreground shadow-sm w-full max-w-md">
            <div class="flex flex-col space-y-1.5 p-6">
                <h3 class="text-2xl font-semibold leading-none tracking-tight">Masuk ke DocExtract AI</h3>
                <p class="text-sm text-muted-foreground">Gunakan akun Anda untuk mengakses dashboard</p>
            </div>
            ...
            <div class="p-6 pt-0 space-y-6">
                ...
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-2 bg-background text-muted-foreground">Atau lanjutkan dengan email</span>
                    </div>
                </div>
